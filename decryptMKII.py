...
for letter in plain_text:
    if letter == "¶":
        ...
        new_position = ((char_position - (int(str(shift_key)[2])*3) - 65) % 26) + 65
        new_letter = chr(new_position)
        cipher_text += new_letter
    elif letter.islower():
        char_position = ord(letter)
        new_position = ((char_position - (int(str(shift_key)[2])*3) - 97) % 26) + 97
        new_letter = chr(new_position)
        cipher_text += new_letter
    elif letter.isnumeric():
        char_position = ord(letter)
        new_position = ((char_position - (int(str(shift_key)[2])*3) - 48) % 10) + 48
        new_letter = chr(new_position)
        cipher_text += new_letter
    else:
        cipher_text += letter
...
for letter in cipher_text2:
    if letter == "¶":
        ...
        new_position3 = ((char_position3 - (int(str(shift_key)[0])) - 65) % 26) + 65
        new_letter3 = chr(new_position3)
        cipher_text3 += new_letter3
    elif letter.islower():
        char_position3 = ord(letter)
        new_position3 = ((char_position3 - (int(str(shift_key)[0])) - 97) % 26) + 97
        new_letter3 = chr(new_position3)
        cipher_text3 += new_letter3
    elif letter.isnumeric():
        char_position3 = ord(letter)
        new_position3 = ((char_position3 - (int(str(shift_key)[0])) - 48) % 10) + 48
        new_letter3 = chr(new_position3)
        cipher_text3 += new_letter3
    else:
        cipher_text3 += letter
